...
public:
    ...
    static struct LEFT
    {
        ...
        const static double matQuaternionToIMU[4];
        const static double vecTranslationToIMU[3];
...
const CPinholeCamera CConfigurationCamera::LEFT::cPinholeCamera = CPinholeCamera( "LEFT", matIntrinsic, vecDistortionCoefficients, matRectification, matProjection, matQuaternionToIMU, vecTranslationToIMU, uWidth, uHeight );
...
const CPinholeCamera CConfigurationCamera::RIGHT::cPinholeCamera = CPinholeCamera( "RIGHT", matIntrinsic, vecDistortionCoefficients, matRectification, matProjection, matQuaternionToIMU, vecTranslationToIMU, uWidth, uHeight );
