...
private:
    ...
    const UIDKeyFrame m_uIDDeltaKeyFrameForOptimization = 100;
    ...
    uint8_t m_uMinimumFrameDeltaForKeyFrame       = 20;
    const UIDKeyFrame m_uBufferSizeSlidingWindow  = 10000;
    std::pair< CPoint3DWORLD, CKeyFrame* >* m_arrFramesSlidingWindow;
    uint8_t m_uIndexSlidingWindow                 = 7;
    ...
    Eigen::Isometry3d m_matTransformationLEFTtoWORLDSlidingWindow;
...
public:
    ...
    const Eigen::Isometry3d getFrameLEFTtoWORLDSlidingWindow( ){ m_bIsFrameAvailableSlidingWindow = false; return m_matTransformationLEFTtoWORLDSlidingWindow; }
