...
private:
    ...
    //ds slam points
    std::vector< std::tuple< CPoint2DInCameraFrame, CPoint3DInCameraFrame, cv::KeyPoint, CDescriptor, Eigen::Isometry3d, CColorCodeBGR, CPoint2DInCameraFrame > > m_vecReferencePoints;
