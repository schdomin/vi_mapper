...
//ds readability
typedef Eigen::Vector2d CPoint2DOnCameraPlane;
...
private:
    ...
    //ds slam points
    std::vector< std::tuple< CPoint2DOnCameraPlane, CPoint3DInWorldFrame, cv::KeyPoint, CDescriptorSURF, Eigen::Isometry3d, CColorCode > > m_vecReferencePoints;
