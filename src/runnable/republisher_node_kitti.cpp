...
int main( int argc, char **argv )
{
    ...
    //ds default files
    std::string strInfileTimestamps = "/media/n551jw/data/n551jw/Downloads/dataset/sequences/00/times.txt";
    std::string strImageFolderLEFT  = "/media/n551jw/data/n551jw/Downloads/dataset/sequences/00/image_0/";
    std::string strImageFolderRIGHT = "/media/n551jw/data/n551jw/Downloads/dataset/sequences/00/image_1/";
    ...
    std::printf( "(main) starting parsing: \n" );

    //ds playback the dump
    while( uIndex < vecTimestampsSeconds.size( )-1 && ros::ok( ) )
    {
        ...
        //ds read a message
        readNextMessageFromFile( vecTimestampsSeconds[uIndex], strImageFolderLEFT, strImageFolderRIGHT, uSleepMicroseconds );
